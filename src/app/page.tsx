...
export const metadata: Metadata = {
  ...
  description:
    "WebCreare bietet professionelle Webentwicklung, Webdesign und SEO-Optimierung am Tegernsee. Faire Preise, schnelle Ladezeiten und individuelle Lösungen für Ihr Unternehmen.",
  keywords:
    "Webdesign Tegernsee, Webentwicklung Bayern, SEO Optimierung, Responsive Design, WordPress CMS, Local SEO",
  authors: [{ name: "WebCreare Team" }],
  openGraph: {
    title: "WebCreare - Webdesign & Entwicklung am Tegernsee",
    description:
      "Individuelle Websites mit Top-Performance und lokalem SEO-Fokus",
    type: "website",
    locale: "de_DE",
  },
  robots: {
  ...
  const serviceItems = [
    {
      ...
      bodyText: [
        ...
        "Flexible Anpassung der Öffnungszeiten",
        "Professionelle Bildoptimierung",
        "Ihr persönlicher Ansprechpartner – immer für Sie da",
        "Individuelle Designanpassungen",
        "Hinzufügen und Aktualisieren von E-Mail-Adressen",
    ...
    },
    {
      ...
      bodyText: [
        ...
        "Professionelle E-Mail-Postfächer",
        "Effektiver DDoS-Schutz",
        "Blitzschnelles Speedhosting mit NGINX",
        "Schnelle Direktlieferung",
        "Intelligentes dynamisches Caching",
  ...
  const achivementBadges = [
    ...
    },
    {
      ...
      svg: (
        ...
        >
          <path
            d="M8.25 45C7.836 45 7.5 44.664 7.5 44.25V43.0965C7.5 40.458 9.528 37.6005 12.0195 36.726L18.186 34.569L18.5925 31.314C18.6435 30.9 19.044 30.6015 19.4295 30.6615C19.8405 30.7125 20.133 31.0875 20.082 31.4985L19.617 35.2155C19.5825 35.4975 19.3905 35.7375 19.1205 35.8305L12.5145 38.142C10.6095 38.8095 9 41.0805 9 43.0965V44.25C9 44.664 8.664 45 8.25 45Z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="M36.75 45C36.336 45 36 44.664 36 44.25V43.0965C36 41.079 34.3905 38.8095 32.4855 38.1405L25.8795 35.829C25.6095 35.7345 25.4175 35.496 25.383 35.2155L24.9165 31.4955C24.8655 31.0845 25.1565 30.7095 25.5675 30.657C25.974 30.6015 26.3535 30.894 26.406 31.308L26.814 34.569L32.9805 36.726C35.472 37.6005 37.5 40.4595 37.5 43.0965V44.25C37.5 44.664 37.164 45 36.75 45Z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="M22.5 33.0585C22.086 33.0585 21.75 32.7225 21.75 32.3085C21.75 31.8945 22.086 31.5585 22.5 31.5585C24.1725 31.5585 27.2865 31.5585 27.3015 23.352C27.3045 21.912 27.1995 20.5125 25.9005 19.212C25.134 18.4455 23.991 18.057 22.4985 18.057C21.006 18.057 19.863 18.4455 19.0965 19.212C17.799 20.5125 17.6925 21.912 17.6955 23.352C17.703 27.228 18.4095 29.7375 19.7955 30.813C20.1225 31.068 20.1825 31.5375 19.929 31.866C19.6725 32.193 19.2045 32.25 18.876 31.9995C17.0805 30.606 16.2045 27.78 16.1955 23.355C16.1925 21.732 16.332 19.8585 18.036 18.1515C19.0935 17.094 20.595 16.557 22.4985 16.557C24.402 16.557 25.9035 17.0925 26.961 18.1515C28.665 19.8585 28.8045 21.732 28.8015 23.355C28.788 30.066 26.8455 33.0585 22.5 33.0585Z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="
z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="M1.0965 27.153C0.741 27.153 0.426 26.8995 0.36 26.5365C0.1215 25.2105 0 23.8515 0 22.5C0 10.0935 10.0935 0 22.5 0C34.9065 0 45 10.0935 45 22.5C45 23.8245 44.883 25.1565 44.6535 26.457C44.58 26.865 44.1825 27.144 43.785 27.0645C43.377 26.9925 43.1055 26.6025 43.1775 26.196C43.392 24.9795 43.5 23.736 43.5 22.5C43.5 10.92 34.08 1.5 22.5 1.5C10.92 1.5 1.5 10.92 1.5 22.5C1.5 23.7645 1.6125 25.032 1.8375 26.2695C1.911 26.676 1.6395 27.0675 1.233 27.141C1.1865 27.1485 1.143 27.153 1.0965 27.153Z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="M10.0335 19.5C9.996 19.5 9.957 19.497 9.9195 19.491C9.51 19.4295 9.228 19.047 9.291 18.6375C10.4685 10.8825 15.2865 3.9795 22.1775 0.1695C22.5405 -0.0299999 22.998 0.099 23.1975 0.462C23.3985 0.825 23.2665 1.281 22.905 1.482C16.4175 5.0685 11.883 11.565 10.7745 18.8625C10.719 19.233 10.398 19.5 10.0335 19.5Z"
            fill="var(--accent-color)"
          ></path>
          <path
            d="M34.9665 19.5C34.6035 19.5 34.2825 19.233 34.227 18.8625C33.12 11.5665 28.5855 5.07 22.0995 1.4835C21.738 1.2825 21.606 0.8265 21.807 0.4635C22.008 0.1005 22.4625 -0.027 22.827 0.171C29.718 3.981 34.5345 10.8855 35.7105 18.6375C35.7735 19.047 35.4915 19.4295 35.082 19.491C35.0415 19.497 35.004 19.5 34.9665 19.5Z"
            fill="var(--accent-color)"
          ></path>
        </svg>
      ),
...
🤝 Das Erstgespräch inkl. grober Konzeption ist kostenlos. Wir starten erst, wenn Ihnen Idee, Designrichtung und Angebot zusagen.`,
    },
    {
      id: 2,
      frage: "Wie lange dauert es bis zur fertigen Website?",
      antwort: `⏱️ Die Dauer hängt vom Umfang und Ihrem Feedbacktempo ab:
...
Auf Wunsch erhalten Sie eine Einweisung zur eigenständigen Pflege. Die ersten Schritte (Kennenlernen + grobe Konzeption) bleiben kostenlos.`,
    },
    {
      ...
      antwort: `🧭 Hilfreich zum Start:
• Kurzinfo zu Unternehmen, Zielgruppe & Zielen
• Vorhandenes Logo, Farben oder Branding
• Texte & Bilder (oder wir unterstützen Sie dabei)

👤 Wichtig ist eine feste Ansprechperson, die Feedback gibt und zügige Freigaben ermöglicht.`,
    },
    {
      id: 6,
      frage: "Bietet ihr auch Betreuung nach dem Go-Live an?",
      antwort: `🔧 Ja, auf Wunsch übernehmen wir:
• Technische Wartung (Updates, Backups, Security)
• Inhaltliche Anpassungen oder neue Seiten
• Laufende Optimierungen per Stundenkontingent

So bleibt Ihre Website nicht nur online, sondern langfristig aktuell und leistungsfähig.`,
    },
  ];
      ...
      <main>
        ...
        >
          <div aria-hidden="true">
            ...
            <div className="pointer-events-none absolute inset-x-20 top-8 hidden lg:flex justify-end lg:top-75">
        ...
        <section
          className="slider-container bg-[var(--accent-color)] font-bold my-20 uppercase text-2xl"
          aria-label="Unsere Kompetenzen"
        >
          {sliders.map((slider) => (
            <Slider
              key={slider.id}
        ...
        <section
          ...
          aria-labelledby="ueberuns-heading"
        >
          <article>
            <SubAndMainHeader
              subheader="Über uns"
        ...
        <section className="my-20" aria-labelledby="wachstum-heading">
